    ...
    def get_add_record_query(self, record_model, c_constraints=None, sub_operation=None):
        ...
        if self.type_test == DAOBase.QueryType.DIRECT_CALL:
            if not self.withFK:
                ...
                return "insert into tb_maintable_fk(anytext,fktest) values ('{}',{})".format(record_model.anytext,record_model.fktest)
...
if __name__ == "__main__":
    driver = 'mssql'
    query_type_test = DAOBase.QueryType.SP_WITH_SELECT_ID
    fl_reread=True
    withFK = False
